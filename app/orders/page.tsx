    ...
    if (data.session.refetch_done_flag && !data.session.diff_confirmed_flag) {
      ...
      if (recovery.success && recovery.review) {
        ...
        setDiffResult({
          ...
          resolved_uninitialized_count:
            review.resolved_uninitialized_count,
          resolved_uninitialized_reason:
            review.resolved_uninitialized_reason,
          ...
          can_initialize:
            typeof review.can_initialize === "boolean"
              ? review.can_initialize
              : undefined,
